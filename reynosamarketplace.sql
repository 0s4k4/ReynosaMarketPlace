...
-- Volcando estructura de base de datos para reynosamarketplace
CREATE DATABASE IF NOT EXISTS `reynosamarketplace` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `reynosamarketplace`;

-- Volcando estructura para tabla reynosamarketplace.oc_address
...
-- Volcando datos para la tabla reynosamarketplace.oc_address: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_address_format
...
-- Volcando datos para la tabla reynosamarketplace.oc_address_format: ~1 rows (aproximadamente)
INSERT INTO `oc_address_format` (`address_format_id`, `name`, `address_format`) VALUES
	(1, 'Address Format', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');

-- Volcando estructura para tabla reynosamarketplace.oc_api
...
-- Volcando datos para la tabla reynosamarketplace.oc_api: ~1 rows (aproximadamente)
INSERT INTO `oc_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
	(1, 'Default', '', 1, '2022-09-11 23:20:38', '2022-09-11 23:20:38');

-- Volcando estructura para tabla reynosamarketplace.oc_api_ip
...
-- Volcando datos para la tabla reynosamarketplace.oc_api_ip: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_api_session
...
-- Volcando datos para la tabla reynosamarketplace.oc_api_session: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_attribute
...
-- Volcando datos para la tabla reynosamarketplace.oc_attribute: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_attribute_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_attribute_description: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_attribute_group
...
-- Volcando datos para la tabla reynosamarketplace.oc_attribute_group: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_attribute_group_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_attribute_group_description: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_banner
...
-- Volcando datos para la tabla reynosamarketplace.oc_banner: ~3 rows (aproximadamente)
INSERT INTO `oc_banner` (`banner_id`, `name`, `status`) VALUES
	(6, 'HP Products', 1),
	(7, 'Home Page Slideshow', 1),
	(8, 'Manufacturers', 1);

-- Volcando estructura para tabla reynosamarketplace.oc_banner_image
...
-- Volcando datos para la tabla reynosamarketplace.oc_banner_image: ~14 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_cart
...
-- Volcando datos para la tabla reynosamarketplace.oc_cart: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_category
...
-- Volcando datos para la tabla reynosamarketplace.oc_category: ~38 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_category_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_category_description: ~38 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_category_filter
...
-- Volcando datos para la tabla reynosamarketplace.oc_category_filter: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_category_path
...
-- Volcando datos para la tabla reynosamarketplace.oc_category_path: ~71 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_category_to_layout
...
-- Volcando datos para la tabla reynosamarketplace.oc_category_to_layout: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_category_to_store
...
-- Volcando datos para la tabla reynosamarketplace.oc_category_to_store: ~38 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_country
...
-- Volcando datos para la tabla reynosamarketplace.oc_country: ~253 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_coupon
...
-- Volcando datos para la tabla reynosamarketplace.oc_coupon: ~3 rows (aproximadamente)
INSERT INTO `oc_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
	(4, '-10% Discount', '2222', 'P', 10.0000, 0, 0, 0.0000, '2014-01-01', '2020-01-01', 10, '10', 0, '2009-01-27 13:55:03'),
	(5, 'Free Shipping', '3333', 'P', 0.0000, 0, 1, 100.0000, '2014-01-01', '2014-02-01', 10, '10', 0, '2009-03-14 21:13:53'),
	(6, '-10.00 Discount', '1111', 'F', 10.0000, 0, 0, 10.0000, '2014-01-01', '2020-01-01', 100000, '10000', 0, '2009-03-14 21:15:18');

-- Volcando estructura para tabla reynosamarketplace.oc_coupon_category
...
-- Volcando datos para la tabla reynosamarketplace.oc_coupon_category: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_coupon_history
...
-- Volcando datos para la tabla reynosamarketplace.oc_coupon_history: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_coupon_product
...
-- Volcando datos para la tabla reynosamarketplace.oc_coupon_product: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_cron
...
-- Volcando datos para la tabla reynosamarketplace.oc_cron: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_currency
...
-- Volcando datos para la tabla reynosamarketplace.oc_currency: ~8 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_customer
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_activity
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_activity: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_affiliate
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_affiliate: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_affiliate_report
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_affiliate_report: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_approval
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_approval: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_group
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_group: ~1 rows (aproximadamente)
INSERT INTO `oc_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
	(1, 0, 1);

-- Volcando estructura para tabla reynosamarketplace.oc_customer_group_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_group_description: ~1 rows (aproximadamente)
INSERT INTO `oc_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
	(1, 1, 'Default', 'test');

-- Volcando estructura para tabla reynosamarketplace.oc_customer_history
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_history: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_ip
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_ip: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_login
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_login: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_online
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_online: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_payment
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_payment: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_reward
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_reward: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_search
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_search: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_transaction
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_transaction: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_customer_wishlist
...
-- Volcando datos para la tabla reynosamarketplace.oc_customer_wishlist: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_custom_field
...
-- Volcando datos para la tabla reynosamarketplace.oc_custom_field: ~27 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_custom_field_customer_group
...
-- Volcando datos para la tabla reynosamarketplace.oc_custom_field_customer_group: ~27 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_custom_field_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_custom_field_description: ~27 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_custom_field_value
...
-- Volcando datos para la tabla reynosamarketplace.oc_custom_field_value: ~27 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_custom_field_value_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_custom_field_value_description: ~27 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_download
...
-- Volcando datos para la tabla reynosamarketplace.oc_download: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_download_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_download_description: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_download_report
...
-- Volcando datos para la tabla reynosamarketplace.oc_download_report: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_event
...
-- Volcando datos para la tabla reynosamarketplace.oc_event: ~43 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_extension
...
-- Volcando datos para la tabla reynosamarketplace.oc_extension: ~40 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_extension_install
...
-- Volcando datos para la tabla reynosamarketplace.oc_extension_install: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_extension_path
...
-- Volcando datos para la tabla reynosamarketplace.oc_extension_path: ~359 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_filter
...
-- Volcando datos para la tabla reynosamarketplace.oc_filter: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_filter_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_filter_description: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_filter_group
...
-- Volcando datos para la tabla reynosamarketplace.oc_filter_group: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_filter_group_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_filter_group_description: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_gdpr
...
-- Volcando datos para la tabla reynosamarketplace.oc_gdpr: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_geo_zone
...
-- Volcando datos para la tabla reynosamarketplace.oc_geo_zone: ~2 rows (aproximadamente)
INSERT INTO `oc_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
	(3, 'UK VAT Zone', 'UK VAT', '2009-01-06 23:26:25', '2010-02-26 22:33:24'),
	(4, 'UK Shipping', 'UK Shipping Zones', '2009-06-23 01:14:53', '2010-12-15 15:18:13');

-- Volcando estructura para tabla reynosamarketplace.oc_information
...
-- Volcando datos para la tabla reynosamarketplace.oc_information: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_information_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_information_description: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_information_to_layout
...
-- Volcando datos para la tabla reynosamarketplace.oc_information_to_layout: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_information_to_store
...
-- Volcando datos para la tabla reynosamarketplace.oc_information_to_store: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_language
...
-- Volcando datos para la tabla reynosamarketplace.oc_language: ~1 rows (aproximadamente)
INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
	(1, 'English', 'en-gb', 'en-gb,en', '', 1, 1);

-- Volcando estructura para tabla reynosamarketplace.oc_layout
...
-- Volcando datos para la tabla reynosamarketplace.oc_layout: ~13 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_layout_module
...
-- Volcando datos para la tabla reynosamarketplace.oc_layout_module: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_layout_route
...
-- Volcando datos para la tabla reynosamarketplace.oc_layout_route: ~14 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_length_class
...
-- Volcando datos para la tabla reynosamarketplace.oc_length_class: ~3 rows (aproximadamente)
INSERT INTO `oc_length_class` (`length_class_id`, `value`) VALUES
	(1, 1.00000000),
	(2, 10.00000000),
	(3, 0.39370000);

-- Volcando estructura para tabla reynosamarketplace.oc_length_class_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_length_class_description: ~3 rows (aproximadamente)
INSERT INTO `oc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
	(1, 1, 'Centimeter', 'cm'),
	(2, 1, 'Millimeter', 'mm'),
	(3, 1, 'Inch', 'in');

-- Volcando estructura para tabla reynosamarketplace.oc_location
...
-- Volcando datos para la tabla reynosamarketplace.oc_location: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_manufacturer
...
-- Volcando datos para la tabla reynosamarketplace.oc_manufacturer: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_manufacturer_to_layout
...
-- Volcando datos para la tabla reynosamarketplace.oc_manufacturer_to_layout: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_manufacturer_to_store
...
-- Volcando datos para la tabla reynosamarketplace.oc_manufacturer_to_store: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_marketing
...
-- Volcando datos para la tabla reynosamarketplace.oc_marketing: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_marketing_report
...
-- Volcando datos para la tabla reynosamarketplace.oc_marketing_report: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_module
...
-- Volcando datos para la tabla reynosamarketplace.oc_module: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_notification
...
-- Volcando datos para la tabla reynosamarketplace.oc_notification: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_option
...
-- Volcando datos para la tabla reynosamarketplace.oc_option: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_option_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_option_description: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_option_value
...
-- Volcando datos para la tabla reynosamarketplace.oc_option_value: ~14 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_option_value_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_option_value_description: ~14 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_order
...
-- Volcando datos para la tabla reynosamarketplace.oc_order: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_order_history
...
-- Volcando datos para la tabla reynosamarketplace.oc_order_history: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_order_option
...
-- Volcando datos para la tabla reynosamarketplace.oc_order_option: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_order_product
...
-- Volcando datos para la tabla reynosamarketplace.oc_order_product: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_order_status
...
-- Volcando datos para la tabla reynosamarketplace.oc_order_status: ~14 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_order_total
...
-- Volcando datos para la tabla reynosamarketplace.oc_order_total: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_order_voucher
...
-- Volcando datos para la tabla reynosamarketplace.oc_order_voucher: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_product
...
-- Volcando datos para la tabla reynosamarketplace.oc_product: ~19 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_attribute
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_attribute: ~5 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_description: ~19 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_discount
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_discount: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_filter
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_filter: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_product_image
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_image: ~61 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_option
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_option: ~12 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_option_value
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_option_value: ~16 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_related
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_related: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_report
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_report: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_product_reward
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_reward: ~19 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_special
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_special: ~3 rows (aproximadamente)
INSERT INTO `oc_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
	(419, 42, 1, 1, 90.0000, '0000-00-00', '0000-00-00'),
	(438, 30, 1, 1, 80.0000, '0000-00-00', '0000-00-00'),
	(439, 30, 1, 2, 90.0000, '0000-00-00', '0000-00-00');

-- Volcando estructura para tabla reynosamarketplace.oc_product_subscription
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_subscription: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_product_to_category
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_to_category: ~30 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_to_download
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_to_download: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_product_to_layout
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_to_layout: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_product_to_store
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_to_store: ~19 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_product_viewed
...
-- Volcando datos para la tabla reynosamarketplace.oc_product_viewed: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_return
...
-- Volcando datos para la tabla reynosamarketplace.oc_return: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_return_action
...
-- Volcando datos para la tabla reynosamarketplace.oc_return_action: ~3 rows (aproximadamente)
INSERT INTO `oc_return_action` (`return_action_id`, `language_id`, `name`) VALUES
	(1, 1, 'Refunded'),
	(2, 1, 'Credit Issued'),
	(3, 1, 'Replacement Sent');

-- Volcando estructura para tabla reynosamarketplace.oc_return_history
...
-- Volcando datos para la tabla reynosamarketplace.oc_return_history: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_return_reason
...
-- Volcando datos para la tabla reynosamarketplace.oc_return_reason: ~5 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_return_status
...
-- Volcando datos para la tabla reynosamarketplace.oc_return_status: ~3 rows (aproximadamente)
INSERT INTO `oc_return_status` (`return_status_id`, `language_id`, `name`) VALUES
	(1, 1, 'Pending'),
	(2, 1, 'Awaiting Products'),
	(3, 1, 'Complete');

-- Volcando estructura para tabla reynosamarketplace.oc_review
...
-- Volcando datos para la tabla reynosamarketplace.oc_review: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_seo_url
...
-- Volcando datos para la tabla reynosamarketplace.oc_seo_url: ~75 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_session
...
-- Volcando datos para la tabla reynosamarketplace.oc_session: ~1 rows (aproximadamente)
INSERT INTO `oc_session` (`session_id`, `data`, `expire`) VALUES
	('c81f9d2a49beda1a433a5f454c', '{"currency":"USD"}', '2022-09-13 04:21:19');

-- Volcando estructura para tabla reynosamarketplace.oc_setting
...
-- Volcando datos para la tabla reynosamarketplace.oc_setting: ~206 rows (aproximadamente)
INSERT INTO `oc_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
	...
	(44, 0, 'config', 'config_invoice_prefix', 'INV-2022-00', 0),
	...
	(207, 0, 'config', 'config_email', 'soulbosss@gmail.com', 0),
	(208, 0, 'config', 'config_encryption', '', 0),
	(209, 0, 'config', 'config_api_id', '1', 0);

-- Volcando estructura para tabla reynosamarketplace.oc_startup
...
-- Volcando datos para la tabla reynosamarketplace.oc_startup: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_statistics
...
-- Volcando datos para la tabla reynosamarketplace.oc_statistics: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_stock_status
...
-- Volcando datos para la tabla reynosamarketplace.oc_stock_status: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_store
...
-- Volcando datos para la tabla reynosamarketplace.oc_store: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_subscription
...
-- Volcando datos para la tabla reynosamarketplace.oc_subscription: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_subscription_history
...
-- Volcando datos para la tabla reynosamarketplace.oc_subscription_history: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_subscription_plan
...
-- Volcando datos para la tabla reynosamarketplace.oc_subscription_plan: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_subscription_plan_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_subscription_plan_description: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_subscription_status
...
-- Volcando datos para la tabla reynosamarketplace.oc_subscription_status: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_subscription_transaction
...
-- Volcando datos para la tabla reynosamarketplace.oc_subscription_transaction: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_tax_class
...
-- Volcando datos para la tabla reynosamarketplace.oc_tax_class: ~2 rows (aproximadamente)
INSERT INTO `oc_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
	(9, 'Taxable Goods', 'Taxed goods', '2009-01-06 23:21:53', '2011-09-23 14:07:50'),
	(10, 'Downloadable Products', 'Downloadable', '2011-09-21 22:19:39', '2011-09-22 10:27:36');

-- Volcando estructura para tabla reynosamarketplace.oc_tax_rate
...
-- Volcando datos para la tabla reynosamarketplace.oc_tax_rate: ~2 rows (aproximadamente)
INSERT INTO `oc_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
	(86, 3, 'VAT (20%)', 20.0000, 'P', '2011-03-09 21:17:10', '2011-09-22 22:24:29'),
	(87, 3, 'Eco Tax (-2.00)', 2.0000, 'F', '2011-09-21 21:49:23', '2011-09-23 00:40:19');

-- Volcando estructura para tabla reynosamarketplace.oc_tax_rate_to_customer_group
...
-- Volcando datos para la tabla reynosamarketplace.oc_tax_rate_to_customer_group: ~2 rows (aproximadamente)
INSERT INTO `oc_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
	(86, 1),
	(87, 1);

-- Volcando estructura para tabla reynosamarketplace.oc_tax_rule
...
-- Volcando datos para la tabla reynosamarketplace.oc_tax_rule: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_theme
...
-- Volcando datos para la tabla reynosamarketplace.oc_theme: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_translation
...
-- Volcando datos para la tabla reynosamarketplace.oc_translation: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_upload
...
-- Volcando datos para la tabla reynosamarketplace.oc_upload: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_user
...
-- Volcando datos para la tabla reynosamarketplace.oc_user: ~1 rows (aproximadamente)
INSERT INTO `oc_user` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
	(1, 1, 'admin', '$2y$10$W506YWf3yKP/AqTcGdwbEO4lNm7f7xf.Yjot2/ykm4hUZkrHOdxeK', 'John', 'Doe', 'soulbosss@gmail.com', '', '', '', 1, '2022-09-11 23:20:38');

-- Volcando estructura para tabla reynosamarketplace.oc_user_group
...
-- Volcando datos para la tabla reynosamarketplace.oc_user_group: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_user_login
...
-- Volcando datos para la tabla reynosamarketplace.oc_user_login: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_vendor
...
-- Volcando datos para la tabla reynosamarketplace.oc_vendor: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_voucher
...
-- Volcando datos para la tabla reynosamarketplace.oc_voucher: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_voucher_history
...
-- Volcando datos para la tabla reynosamarketplace.oc_voucher_history: ~0 rows (aproximadamente)

-- Volcando estructura para tabla reynosamarketplace.oc_voucher_theme
...
-- Volcando datos para la tabla reynosamarketplace.oc_voucher_theme: ~3 rows (aproximadamente)
INSERT INTO `oc_voucher_theme` (`voucher_theme_id`, `image`) VALUES
	(6, 'catalog/demo/apple_logo.jpg'),
	(7, 'catalog/demo/gift-voucher-birthday.jpg'),
	(8, 'catalog/demo/canon_eos_5d_2.jpg');

-- Volcando estructura para tabla reynosamarketplace.oc_voucher_theme_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_voucher_theme_description: ~3 rows (aproximadamente)
INSERT INTO `oc_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
	(6, 1, 'Christmas'),
	(7, 1, 'Birthday'),
	(8, 1, 'General');

-- Volcando estructura para tabla reynosamarketplace.oc_weight_class
...
-- Volcando datos para la tabla reynosamarketplace.oc_weight_class: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_weight_class_description
...
-- Volcando datos para la tabla reynosamarketplace.oc_weight_class_description: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_zone
...
-- Volcando datos para la tabla reynosamarketplace.oc_zone: ~4,031 rows (aproximadamente)
...
-- Volcando estructura para tabla reynosamarketplace.oc_zone_to_geo_zone
...
-- Volcando datos para la tabla reynosamarketplace.oc_zone_to_geo_zone: ~108 rows (aproximadamente)
